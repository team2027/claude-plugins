...
- **Lead with the demo**: the most convincing, tangible proof it works, up top.
- Then the "what it is / why it matters" in a few tight lines.
- Then scope, risks, and what shipping actually requires.
- Keep it skimmable for a busy audience — headers, short paragraphs, no wall of text.
