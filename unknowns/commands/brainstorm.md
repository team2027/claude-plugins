...
Search the codebase to ground yourself, then brainstorm **10 places we could intervene**, ordered from **cheapest / lowest-effort to most ambitious**.

For each idea give me:
- A one-line description of the intervention.
- Roughly where in the code it would live (`file:line` or module).
